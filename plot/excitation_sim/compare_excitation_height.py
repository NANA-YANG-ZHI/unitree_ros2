...
How to record (two terminals, both after sourcing your ROS2 workspace):
    # terminal 1
    ros2 bag record -o excitation_height_bag /lf/sportmodestate /excitation_height/desired
    # terminal 2 (start right after, or right before, terminal 1)
    ros2 run <your_package> excitation_height
...
The bag must contain:
  ...
  /excitation_height/desired   (geometry_msgs/msg/PointStamped)   — desired commands
...
Usage (source your ROS2 workspace first):
    python3 compare_excitation_height.py <path_to_bag_folder>
"""
...
if len(sys.argv) < 2:
    print("Usage: python3 compare_excitation_height.py <bag_folder>")
    sys.exit(1)
...
DESIRED_TOPIC = "/excitation_height/desired"
...
fig.suptitle("Actual vs Desired — excitation_height", fontsize=13)
...
plt.tight_layout()
fig.savefig("compare_excitation_height.png", dpi=150)
print("Saved: compare_excitation_height.png")
